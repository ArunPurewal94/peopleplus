...
<form method="POST" class="card" use:enhance={() => {
    ...
    <h1 class="text-2xl mb-8 text-center">Register</h1>
    <div class="form-control gap-2 mb-4">
        ...
        <input type="password" name="passwordConfirm" placeholder="Confirm Password..." class="input input-bordered bg-gray-100 dark:bg-base-200" />
